...
import (
	cue_uuid "uuid"
	t "opmodel.dev/opm/core/types@v1"
	module "opmodel.dev/opm/core/module@v1"
	policy "opmodel.dev/opm/core/policy@v1"
)
...
#Bundle: {
	apiVersion: "opmodel.dev/opm/core/v1alpha2"
	kind:       "Bundle"

	metadata: {
		modulePath!: t.#ModulePathType                                     // Example: "opmodel.dev/opm/bundles/core"
