...
#CronJobTransformer: transformer.#Transformer & {
	...
	requiredTraits: {
		"opmodel.dev/opm/traits/workload/cron-job-config@v1": workload_traits.#CronJobConfigTrait
	}
	...
	#transform: {
		...
		output: k8sbatchv1.#CronJob & {
			...
			spec: {
				...
				concurrencyPolicy: *requiredTraits["opmodel.dev/opm/traits/workload/cron-job-config@v1"].#defaults.concurrencyPolicy | string
				if _cronConfig.concurrencyPolicy != _|_ {
					concurrencyPolicy: _cronConfig.concurrencyPolicy
				}

				successfulJobsHistoryLimit: *requiredTraits["opmodel.dev/opm/traits/workload/cron-job-config@v1"].#defaults.successfulJobsHistoryLimit | int
				if _cronConfig.successfulJobsHistoryLimit != _|_ {
					successfulJobsHistoryLimit: _cronConfig.successfulJobsHistoryLimit
				}

				failedJobsHistoryLimit: *requiredTraits["opmodel.dev/opm/traits/workload/cron-job-config@v1"].#defaults.failedJobsHistoryLimit | int
