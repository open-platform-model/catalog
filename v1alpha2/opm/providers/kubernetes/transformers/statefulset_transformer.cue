...
import (
	"list"
	k8sappsv1 "opmodel.dev/opm/schemas/kubernetes/apps/v1@v1"
...
#StatefulsetTransformer: transformer.#Transformer & {
	...
	optionalTraits: {
		"opmodel.dev/opm/traits/workload/scaling@v1":            workload_traits.#ScalingTrait
		"opmodel.dev/opm/traits/workload/restart-policy@v1":     workload_traits.#RestartPolicyTrait
		"opmodel.dev/opm/traits/workload/update-strategy@v1":    workload_traits.#UpdateStrategyTrait
		"opmodel.dev/opm/traits/workload/health-check@v1":       workload_traits.#HealthCheckTrait
		...
		"opmodel.dev/opm/traits/network/host-network@v1":        network_traits.#HostNetworkTrait
	...
	#transform: {
		...
		_scalingCount: *optionalTraits["opmodel.dev/opm/traits/workload/scaling@v1"].#defaults.count | int
		...
		_restartPolicy: *optionalTraits["opmodel.dev/opm/traits/workload/restart-policy@v1"].#defaults | string
