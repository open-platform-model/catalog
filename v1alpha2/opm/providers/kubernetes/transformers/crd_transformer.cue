...
import (
	...
	extension_resources "opmodel.dev/opm/resources/extension@v1"
	k8sapiextv1 "opmodel.dev/opm/schemas/kubernetes/apiextensions/v1@v1"
)
...
#CRDTransformer: transformer.#Transformer & {
	...
	requiredResources: {
		"opmodel.dev/opm/resources/extension/crds@v1": extension_resources.#CRDsResource
	}
