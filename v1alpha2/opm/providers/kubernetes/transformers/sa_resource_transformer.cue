...
import (
	...
	security_resources "opmodel.dev/opm/resources/security@v1"
)
...
#ServiceAccountResourceTransformer: transformer.#Transformer & {
	...
	requiredResources: {
		"opmodel.dev/opm/resources/security/service-account@v1": security_resources.#ServiceAccountResource
	}
...
_testSAResourceTransformer: (#ServiceAccountResourceTransformer.#transform & {
	...
	#context: {
		#moduleReleaseMetadata: {
			name:      "test-release"
			namespace: "ci"
			fqn:       "opmodel.dev/opm/test-release:0.1.0"
			version:   "0.1.0"
