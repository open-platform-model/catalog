...
// emit #resolution. The Claim's #status stays empty. Validates the
...
// renders a Schedule, but its #transform body omits #resolution entirely.
...
// But injectedModule is empty for nightly (no #resolution emitted).
