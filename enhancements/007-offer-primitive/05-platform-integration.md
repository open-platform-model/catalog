...
These fields extend enhancement 008's `#Platform` definition:

```cue
#Platform: {
    // ... fields from enhancement 008: metadata, type, #ctx, #providers,
    //     #composedTransformers, #provider, #declaredResources, #declaredTraits ...

    // NEW (this enhancement): composed offer registry
    ...
    // Extend the composed provider with offers
    #provider: {
        #offers: #composedOffers
    }

    // NEW: auto-computed offer capabilities
    #declaredOffers: #provider.#declaredOffers

    // NEW: which claim FQNs can this platform satisfy?
    #satisfiedClaims: [
...
This provides a higher-level check beyond transformer matching: is the capability even offered?
...
Transformers: 41 total (from 5 providers)
```
...
#Platform: core.#Platform & {
    ...
    #ctx: {
        ...
        platform: defaultStorageClass: "gp3"
    }
    #providers: [
...
4. Transformer matching (existing — render-time, from enhancement 006/008):
...
- **Transformer check** (enhancement 006): "Can this claim be rendered to platform resources?"
