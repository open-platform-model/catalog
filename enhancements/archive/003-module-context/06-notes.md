...
This discussion should happen before `#ctx` is widely adopted in transformers, to avoid locking in an integration pattern that the migration would need to undo.
