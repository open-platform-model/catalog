...
#DeploymentTransformer: transformer.#Transformer & {
	...
	optionalTraits: {
		"opmodel.dev/opm/v1alpha1/traits/workload/scaling@v1":            workload_traits.#ScalingTrait
		...
		"opmodel.dev/opm/v1alpha1/traits/workload/health-check@v1":       workload_traits.#HealthCheckTrait
		...
		"opmodel.dev/opm/v1alpha1/traits/security/image-pull-secrets@v1": security_traits.#ImagePullSecretsTrait
	...
	#transform: {
		...
		_scalingCount: *optionalTraits["opmodel.dev/opm/v1alpha1/traits/workload/scaling@v1"].#defaults.count | int
