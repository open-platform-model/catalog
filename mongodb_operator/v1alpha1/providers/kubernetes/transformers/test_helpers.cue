...
//
// The uuid is always the RFC 4122 nil-adjacent UUID for deterministic, reproducible test output.
...
#TestCtx: {
	...
	out: transformer.#TransformerContext & {
		#moduleReleaseMetadata: {
			name:      release
			namespace: namespace
			fqn:       "opmodel.dev/mongodb_operator/v1alpha1/modules/\(release)@v0"
			version:   "v0.1.0"
