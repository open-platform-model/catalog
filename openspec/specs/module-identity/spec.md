...
Defines deterministic identity computation for `#Module` and `#ModuleRelease` definitions. Identities are UUID v5 values derived from metadata fields, enabling reliable resource discovery and labeling across deployments and version upgrades.
