...
Defines requirements for filtering pipeline-internal labels and annotations from rendered provider resources, and for typed metadata fields on `#TransformerContext`.
