...
Defines the RBAC Role resource for OPM, collapsing Kubernetes Role/ClusterRole and RoleBinding/ClusterRoleBinding into a single concept with CUE-referenced subjects.
