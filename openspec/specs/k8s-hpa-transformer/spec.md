...
Specifies the Kubernetes HPA transformer, which converts OPM Scaling trait auto-scaling configuration into Kubernetes `autoscaling/v2/HorizontalPodAutoscaler` objects.
