# Kubernetes Schema Re-exports

## Purpose

Re-export upstream Kubernetes CUE schemas from `cue.dev/x/k8s.io@v0` as an OPM-controlled module. Provides version indirection so consumers depend on `opmodel.dev/schemas/kubernetes@v0` rather than upstream directly.
