...
Defines the `#ScalingSchema` struct and supporting types (`#AutoscalingSpec`, `#MetricSpec`, `#MetricTargetSpec`) for horizontal scaling configuration in workload components.
