...
Specifies the WorkloadIdentity trait, which declares a named service identity for workloads. This is a provider-agnostic abstraction — the trait expresses intent ("this workload runs as identity X"), and providers decide how to realize it (e.g., Kubernetes ServiceAccount).
