# Capability: name-value-migration

## Purpose

Migrate all concrete definition name values from PascalCase to kebab-case DNS labels, update FQN references to use the computed `_definitionName` field, and ensure all test fixtures and examples conform to the new naming convention.
