...
Specifies the Kubernetes ServiceAccount transformer, which converts OPM WorkloadIdentity resources into Kubernetes `v1/ServiceAccount` objects and wires `serviceAccountName` into workload transformer pod specs.
