...
Specifies the Kubernetes ServiceAccount transformer, which converts OPM WorkloadIdentity traits into Kubernetes `v1/ServiceAccount` objects and wires `serviceAccountName` into workload transformer pod specs.
