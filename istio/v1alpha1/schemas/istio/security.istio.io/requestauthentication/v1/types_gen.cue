...
#RequestAuthenticationSpec: {
	...
	jwtRules?: list.MaxItems(4096) & [...{
		...
		fromCookies?: [...strings.MinRunes(1)]
		...
		// the JWT.
		jwks_uri?: strings.MaxRunes(2048) & strings.MinRunes(1)

		// URL of the provider's public key set to validate signature of
		// the JWT.
		jwksUri?: strings.MaxRunes(2048) & strings.MinRunes(1)
		...
		spaceDelimitedClaims?: list.MaxItems(64) & [...strings.MinRunes(1)]
